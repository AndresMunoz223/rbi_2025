#ifndef ROVHARDWARECONTROLLER
#define ROVHARDWARECONTROLLER
...
class RovHardwareController : public controller_interface::ControllerInterface{

public:

    RovHardwareController();

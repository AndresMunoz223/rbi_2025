    ...
    public:
        ...
        void sim_thread(){
            ...
            while( !glfwWindowShouldClose(window) && !sim_stop_flag){   
                ...
                this->sim_data_object->ctrl[2] = this->velocity_input[5];
                this->sim_data_object->ctrl[3] = this->velocity_input[5];
                this->sim_data_object->ctrl[4] = this->velocity_input[5];
                this->sim_data_object->ctrl[5] = this->velocity_input[5];

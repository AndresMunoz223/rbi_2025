...
# class Astar3DNode():
    def __init__(self):
        ...
        self.map_x_resolution = 0.05 #[m]
        self.map_y_resolution = 0.05 #[m]
        self.map_z_resolution = 0.05 #[m]
        ...
        self.movements = {
            1: np.array([[-1], [ 0], [ 0]], dtype=int),  # X-
            2: np.array([[ 1], [ 0], [ 0]], dtype=int),  # X+
            3: np.array([[ 0], [-1], [ 0]], dtype=int),  # Y-
            4: np.array([[ 0], [ 1], [ 0]], dtype=int),  # Y+
            5: np.array([[ 0], [ 0], [-1]], dtype=int),  # Z-
            6: np.array([[ 0], [ 0], [ 1]], dtype=int),  # Z+
        }
    ...
    def goal_pose_callback(self, msg :PoseStamped):
        ...
        if self.goal_pose is not None and self.current_position is not None:

...
char filename[] = "/home/eia/repo/rbi_2025_2/rov/rov_ws/src/rov_sim/description/basic_scenario.xml";

namespace rov_simulator_layer {

class RovSimulatorInterface : public hardware_interface::SystemInterface
{
    public:

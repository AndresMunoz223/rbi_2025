...
It is to say, that depth follows the same dynamics, and its also controlled by a P controller of the form $F_z = (z_{ref}-z)k_3$.
...
$$
u = \begin{bmatrix} F_u \\ T_\psi \end{bmatrix} \\
\\
------
\\
x = \begin{bmatrix}
...
\end{bmatrix} | \ \ \dot{x} =  
\begin{bmatrix}
 -\rho_1|\dot{x}|\dot{x} \\ -\rho_2|\dot{\psi}|\dot{\psi} 
\end{bmatrix} + u
$$
